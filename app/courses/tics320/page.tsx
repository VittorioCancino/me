...
export default function TICS320() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12">
      <Link
        href="/"
        className="mb-8 inline-flex items-center gap-1 text-xs text-[#848d97] transition-colors hover:text-[#a78bfa]"
      >
      ...
      <p className="mb-10 text-sm leading-relaxed text-[#848d97]">
        {c.description}
      </p>
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-2xl border border-[#21262d] bg-[#161b22] px-7 py-6">
          ...
          <p className="mb-4 text-xs text-[#848d97]">
            {c.lectures.description}
          </p>
          <p className="text-xs text-[#848d97] italic">{c.lectures.empty}</p>
        </div>
        ...
        <div className="rounded-2xl border border-[#21262d] bg-[#161b22] px-7 py-6">
          ...
          <p className="mb-4 text-xs text-[#848d97]">
            {c.practicum.description}
          </p>
          <ul className="space-y-2">
            {t.practicumItems.map((item) => (
              <li
                key={item.number}
                className="rounded-xl border border-[#21262d] bg-[#0d1117] px-5 py-3"
              >
                <div className="flex items-center gap-3">
                  <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#7c3aed]/20 text-xs font-bold text-[#7c3aed]">
                    {item.number}
                  </span>
                ...
                <p className="mt-1.5 pl-9 text-xs text-[#848d97]">
                  {item.description}
                </p>
              </li>
            ))}
